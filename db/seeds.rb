...
shops = Shop.create([
  ...
  {name: 'KILL vintage clothing（キルビンテージクローシング）', image: open("#{Rails.root}/db/fixtures/KILLvintageclothing.jpg"), area_id: '1', outline: '古着のメッカ下北沢にある古着屋兼ギャラリー。ヨーロッパやアメリカから仕入れたヴィンテージもののブランド古着を主に取り扱っている。確かな感性で選び抜かれた古着の数々は見ているだけでも楽しくなると評判で、とくに女性客から支持を受けている。'},
  ...
  {name: '中目黒THE VINTAGE HOOK（ザ・ヴィンテージ フック）', image: open("#{Rails.root}/db/fixtures/中目黒THEVINTAGEHOOK.jpg"), area_id: '5', outline: '「Go Back 90’s Style」というキャッチコピーを掲げ、ヴィンテージ ハーレーアイテムを中心とした90年台のオールドスケート、ロック等のアイテムを取り扱っている。デッドストックやスペシャルヴィンテージを中心としているため、誰にも真似できない個性的なファッションを目指しているなら一度は覗きたいお店だ。
